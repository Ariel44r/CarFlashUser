...
public class RentalModel: NSObject {
    ...
    internal let kRentalModelDescriptionKey: String = "description"
    ...
    */
    public init(json: JSON) {
        ...
        description1 = json[kRentalModelDescriptionKey].string
		details = []
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
        ...
        if description1 != nil {
            dictionary.updateValue(description1! as AnyObject, forKey: kRentalModelDescriptionKey)
        }
		if (details?.count)! > 0 {
			var temp: [AnyObject] = []
			for item in details! {
