...
class FullDetailsViewController: UIViewController,MainCategoryProtocol {
    ...
    @IBOutlet weak var ridelaterbookingdetailstextlbl: UILabel!
    
    @IBOutlet weak var completeyourtripstextlbl: UILabel!
    
    
    @IBOutlet weak var billdetailstextlbl: UILabel!
    
    @IBOutlet weak var totaldistancetraveltextlbl: UILabel!
    
    
    @IBOutlet weak var distancefaretextlbl: UILabel!
    
    @IBOutlet weak var ridetimechargestextlbl: UILabel!
    
    
    @IBOutlet weak var nighttimechargestextlbl: UILabel!
    
    
    @IBOutlet weak var peaktimechargestextlbl: UILabel!
    
    @IBOutlet weak var waitingchargetextlbl: UILabel!
    
    @IBOutlet weak var totalbilltextlbl: UILabel!
    ...
    @IBOutlet weak var billdetailstextlbl1: UILabel!
    
    @IBOutlet weak var totalpricetextlbl: UILabel!
    
    @IBOutlet weak var mailinvoicetextlbl: UILabel!
    
    @IBOutlet weak var trackridetextlbl: UILabel!
    
    @IBOutlet weak var cancelridetextlbl: UILabel!
    
    @IBOutlet weak var ridelatercancelridetextlbl: UILabel!
    
    @IBOutlet weak var driverarrivertrackridetextlbl: UILabel!
    
    
     func setupView(){
        ridelaterbookingdetailstextlbl.text = "Booking Details".localized
        completeyourtripstextlbl.text = "Your Trip Details :".localized
        billdetailstextlbl.text = "Bill Details".localized
        totaldistancetraveltextlbl.text = "Total Distance travel".localized
        distancefaretextlbl.text = "Distance Fare".localized
        ridetimechargestextlbl.text = "Ride Time Charges".localized
        nighttimechargestextlbl.text = "Night Time Charges ".localized
        peaktimechargestextlbl.text = "Peak Time Charges".localized
        waitingchargetextlbl.text = "Waiting Charge".localized
        totalbilltextlbl.text = "Total Bill".localized
        paymenttextlbl.text = "Payment".localized
        rentaldistancetraveltextlbl.text = "Distance Travel :".localized
        rentaltotaltimetextlbl.text = "Total Time :".localized
        billdetailstextlbl1.text = "Bill Details".localized
        totalpricetextlbl.text = "Total Price".localized
        mailinvoicetextlbl.text = "MAIL INVOICE".localized
        trackridetextlbl.text = "Track Ride".localized
        cancelridetextlbl.text = "Cancel Ride".localized
        ridelatercancelridetextlbl.text = "Cancel Ride".localized
        driverarrivertrackridetextlbl.text = "Track Ride".localized
    ...
    func onSuccessParse(data: AnyObject) {
        ...
        if(GlobalVarible.Api == "rentalviewrideinfo"){
            ...
            if(rentalridedata.status == 1){
                ...
                if ridestausvalue == "10" {
                    bookingdateridelater.text = "Booking Time :- ".localized + datetimedata
                    
                    scheduledateridelater.text = "Schedule Time :- ".localized + (rentalridedata.details?.bookingDate)! + " " + (rentalridedata.details?.bookingTime)!
        ...
        if(GlobalVarible.Api == "normalviewrideinfo"){
            ...
            if(mydatapage.status == 1){
               ...
               scheduledateridelater.text = "Schedule Time :- ".localized + (mydatapage.details?.laterDate)! + " " + (mydatapage.details?.laterTime)!
                ...
                if ridestausvalue == "7" {
                    ...
                    completecoupontext.text = "Coupon Applied".localized + "( " + (mydatapage.details?.couponCode)! + " )"
