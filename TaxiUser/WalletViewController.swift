...
class WalletViewController: UIViewController,MainCategoryProtocol {
    ...
    @IBOutlet var lblWalletMoney: UILabel!
    ...
    func viewSetup(){
        ...
        lblWalletMoney.text = "Wallet Money".localized
        lblCurrentBalance.text = "Current balance".localized
        btnAddMoney.setTitle("Add money To Wallet".localized, for: UIControlState.normal)
