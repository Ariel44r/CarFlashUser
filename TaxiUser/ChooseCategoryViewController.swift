...
class ChooseCategoryViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    //MARK: Outlets    
    @IBOutlet weak var topchoosecategorytextlabel: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()        
        topchoosecategorytextlabel.text = "CHOOSE CATEGORY".localized
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {        
        ...
        imageview.af_setImage(withURL: url1! as URL,
